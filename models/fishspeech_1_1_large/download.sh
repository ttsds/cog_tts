...
if [ ! -d "checkpoints/fishspeech" ]; then
    ...
    rm checkpoints/fishspeech/fish-speech-v1.0.zip
    rm checkpoints/fishspeech/text2semantic-sft-medium-v1.1-4k.pth
    rm checkpoints/fishspeech/text2semantic-sft-large-v1-4k.pth
    rm checkpoints/fishspeech/text2semantic-sft-medium-v1-4k.pth
