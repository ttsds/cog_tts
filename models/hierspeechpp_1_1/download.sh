...
if [ ! -d checkpoints/hierspeechpp_eng_kor ]; then
    ...
    python -m gdown --fuzzy https://drive.google.com/file/d/1xMfhg4qeehGO0RN-zxq-hAnW-omXmpdq/view?usp=drive_link -O checkpoints/hierspeechpp_eng_kor/hierspeechpp_v1_ckpt.pth
